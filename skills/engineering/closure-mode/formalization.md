...
> **Live adoption example:** a personal production project ships this formalization as Step 8 of its `phase-lock` skill. The wiring follows the discipline-vs-executor split named below.
