...
| **Standing cost** | Description ≈ 50 tokens if model-invocable. In the author's setup it runs name-only behind an error-signature router rule (near-zero standing cost); adopters can run it either way. Body ≈ 8 KB + gotchas. |
