...
*This repo's own delta:* the conventions for working inside this repo — layout, maintainer
workflow, authoring rules, the de-personalization gate — live in [AGENTS.md](AGENTS.md).
