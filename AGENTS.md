...
- **Invoking a skill from inside a skill** — write the exact phrase *"Call the Skill tool with `skill-name`."* (Pocock, verbatim, X, 2026-08-24). A bare "run X" or "use X" leaves the invocation to inference; naming the tool and its argument is what makes the call fire reliably.
