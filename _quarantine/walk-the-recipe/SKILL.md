...
For documentation gaps: inline doc edits, single cohesive commit. (See `[[honesty-first]]` for the pattern when both doc and engineering gaps surface together.)
