# EVIDENCE — uniform-eol-rewrite-evades-the-mixed-eol-guard
...
| **Occasions counted** | 2 — 2026-09-06 whole-file rewrite caught only by a diffstat (gotchas.md); 2026-09-07 nineteen URLs written with a trailing CR, every `curl` returning `000`, no commit and therefore no diffstat to catch it (gotchas.md). |
...
- **No admission claim is made.** Two counted occurrences satisfy ADMISSION.md criterion 2's
