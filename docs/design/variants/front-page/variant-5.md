...
>
> **This variant.** Leads with Install, ahead of the admission method and the card map, and
> expands the install section with the manifest/O7 obligation and the version-promise note.
