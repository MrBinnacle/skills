...
>
> **This variant.** Baseline plus the tagline "These aren't the Claude Code skills you're
> looking for." and a paragraph separating the three admission instruments — the policy, the
> gate card, and the screen.
